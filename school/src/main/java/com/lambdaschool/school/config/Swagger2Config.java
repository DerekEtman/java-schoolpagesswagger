...
public class Swagger2Config
{
    ...
    {
        return new ApiInfoBuilder().title("School Swagger")
                .description("School Swagger")
                .contact(new Contact("Derek Etman", "http://www.lambdaschool.com", "Dereketman@gmail.com"))
